...
res = res + "¿El número '123' es finito?" + "<strong>" + 
Number.isFinite('123') + "</strong><br>";
res = res + "¿El número 'hello' es finito?" + "<strong>" + 
Number.isFinite('hello') + "</strong><br>";
...
Number.isFinite("100"-10) + "</strong><br>";
...
function noEsNumero() {
	var res = "";
	res = res + "no es un número 123: " + "<strong>" + Number.isInteger(123) + "</strong><br>";
	res = res + "no es un número -1.23: " + "<strong>" + Number.isInteger(-1.23) + "</strong><br>";
	res = res + "no es un número 5-2: " + "<strong>" + Number.isInteger(5-2) + "</strong><br>";
	res = res + "no es un número 0: " + "<strong>" + Number.isInteger(0) + "</strong><br>";
	res = res + "no es un número 1.23: " + "<strong>" + Number.isInteger(1.23) + "</strong><br>";
	res = res + "no es un número \"123\": " + "<strong>" + Number.isInteger('123') + "</strong><br>";
	res = res + "no es un número \"hello\": " + "<strong>" + Number.isInteger('hello') + "</strong><br>";
	res = res + "no es un número \"2005/12/12\": " + "<strong>" + Number.isInteger('2005/12/12') + "</strong><br>";
	res = res + "no es un número \"0/0\": " + "<strong>" + Number.isInteger(0/0) + "</strong><br>";
	res = res + "no es un número \"10\" + 20: " + "<strong>" + Number.isInteger("10"+20) + "</strong><br>";
...
function aExponencial() {
    var res = "";
	res = res + "El numero" + num + "en exponencial con 1 digito es: " + "<strong>" + num.toExponential(123) + "</strong><br>";
	res = res +  "El numero" + num + "en exponencial con 1 digito es: " + "<strong>" + num.toExponential(-1.23) + "</strong><br>";
	res = res + "El numero" + num + "en exponencial con 1 digito es: " + "<strong>" + num.toExponential(5-2) + "</strong><br>";
	res = res +  "El numero" + num + "en exponencial con 1 digito es: " + "<strong>" + num.toExponential(0) + "</strong><br>";
	res = res +  "El numero" + num + "en exponencial con 1 digito es: " + "<strong>" + num.toExponential(1.23) + "</strong><br>";
	res = res +  "El numero" + num + "en exponencial con 1 digito es: " + "<strong>" + num.toExponential('123') + "</strong><br>";
	res = res +  "El numero" + num + "en exponencial con 1 digito es: " + "<strong>" + num.toExponential('hello') + "</strong><br>";
	res = res + "El numero" + num + "en exponencial con 1 digito es: " + "<strong>" + num.toExponential('2005/12/12') + "</strong><br>";
	res = res +  "El numero" + num + "en exponencial con 1 digito es: " + "<strong>" + num.toExponential(0/0) + "</strong><br>";
	res = res + "en exponencial \"10\" + 20: " + "<strong>" + num.toExponential("10"+20) + "</strong><br>";
...
function aPrecision() {
    var res = "";
	res = res + "Es preciso 123: " + "<strong>" + Number.isInteger(123) + "</strong><br>";
	res = res + "Es preciso -1.23: " + "<strong>" + Number.isInteger(-1.23) + "</strong><br>";
	res = res + "Es preciso 5-2: " + "<strong>" + Number.isInteger(5-2) + "</strong><br>";
	res = res + "Es preciso 0: " + "<strong>" + Number.isInteger(0) + "</strong><br>";
	res = res + "Es preciso 1.23: " + "<strong>" + Number.isInteger(1.23) + "</strong><br>";
	res = res + "Es preciso \"123\": " + "<strong>" + Number.isInteger('123') + "</strong><br>";
	res = res + "Es preciso\"hello\": " + "<strong>" + Number.isInteger('hello') + "</strong><br>";
	res = res + "Es preciso \"2005/12/12\": " + "<strong>" + Number.isInteger('2005/12/12') + "</strong><br>";
	res = res + "Es preciso \"0/0\": " + "<strong>" + Number.isInteger(0/0) + "</strong><br>";
	res = res + "Es preciso \"10\" + 20: " + "<strong>" + Number.isInteger("10"+20) + "</strong><br>";
...
function valorDe() {
	...
	var res = "";
	res = res + "valor de 123: " + "<strong>" + Number.isInteger(123) + "</strong><br>";
	res = res + "valor de -1.23: " + "<strong>" + Number.isInteger(-1.23) + "</strong><br>";
	res = res + "valor de 5-2: " + "<strong>" + Number.isInteger(5-2) + "</strong><br>";
	res = res + "valor de 0: " + "<strong>" + Number.isInteger(0) + "</strong><br>";
	res = res + "valor de 1.23: " + "<strong>" + Number.isInteger(1.23) + "</strong><br>";
	res = res + "valor de \"123\": " + "<strong>" + Number.isInteger('123') + "</strong><br>";
	res = res + "valor de \"hello\": " + "<strong>" + Number.isInteger('hello') + "</strong><br>";
	res = res + "valor de \"2005/12/12\": " + "<strong>" + Number.isInteger('2005/12/12') + "</strong><br>";
	res = res + "valor de \"0/0\": " + "<strong>" + Number.isInteger(0/0) + "</strong><br>";
	res = res + "valor de \"10\" + 20: " + "<strong>" + Number.isInteger("10"+20) + "</strong><br>";
